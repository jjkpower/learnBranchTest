...
#include <QDataStream>
#include <QMessageBox>
TiemClient::TiemClient(QWidget *parent)
    : QDialog(parent)
{
...
void TiemClient::showError(QAbstractSocket::SocketError socketError)
{
    switch (socketError)
    {
